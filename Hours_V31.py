...
if new_pairs:
    with st.spinner("Computing runtimes for missing db files..."):
        for commands_file, messages_file in new_pairs:
            ...
            durations_df = pd.concat([df for df in [durations_df, df_duration_raw] if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in [durations_df, df_duration_raw]]) else pd.DataFrame()
            ...
            new_db_file_duration_df = pd.concat([df for df in all_db_file_duration if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_db_file_duration]) else pd.DataFrame()
            new_runtime_df = pd.concat([df for df in all_runtime if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_runtime]) else pd.DataFrame()
            new_reboiler_df = pd.concat([df for df in all_reboiler if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_reboiler]) else pd.DataFrame()
            new_sorb_df = pd.concat([df for df in all_sorb if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_sorb]) else pd.DataFrame()
            new_bigfan_pwm_df = pd.concat([df for df in all_bigfan_pwm if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_bigfan_pwm]) else pd.DataFrame()
            new_recycle_pump_1_rpm_df = pd.concat([df for df in all_recycle_pump_1_rpm if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_recycle_pump_1_rpm]) else pd.DataFrame()
            new_recycle_pump_2_rpm_df = pd.concat([df for df in all_recycle_pump_2_rpm if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_recycle_pump_2_rpm]) else pd.DataFrame()
            new_weather_df = pd.concat([df for df in all_weather if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_weather]) else pd.DataFrame()
            new_mean_df = pd.concat([df for df in all_mean if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_mean]) else pd.DataFrame()
            new_mean_residence_df = pd.concat([df for df in all_mean_residence if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_mean_residence]) else pd.DataFrame()
            new_compressor_stage_1_df = pd.concat([df for df in all_compressor_stage_1 if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_compressor_stage_1]) else pd.DataFrame()
            new_compressor_stage_2_df = pd.concat([df for df in all_compressor_stage_2 if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_compressor_stage_2]) else pd.DataFrame()
            new_compressor_stage_1_temp_df = pd.concat([df for df in all_compressor_stage_1_temp if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_compressor_stage_1_temp]) else pd.DataFrame()
            new_compressor_stage_2_temp_df = pd.concat([df for df in all_compressor_stage_2_temp if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_compressor_stage_2_temp]) else pd.DataFrame()
            new_aec_stack_1_current_df = pd.concat([df for df in all_aec_stack_1_current if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_1_current]) else pd.DataFrame()
            new_aec_stack_2_current_df = pd.concat([df for df in all_aec_stack_2_current if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_2_current]) else pd.DataFrame()
            new_aec_stack_3_current_df = pd.concat([df for df in all_aec_stack_3_current if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_3_current]) else pd.DataFrame()
            new_aec_stack_4_current_df = pd.concat([df for df in all_aec_stack_4_current if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_4_current]) else pd.DataFrame()
            new_aec_stack_1_current_density_df = pd.concat([df for df in all_aec_stack_1_current_density if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_1_current_density]) else pd.DataFrame()
            new_aec_stack_2_current_density_df = pd.concat([df for df in all_aec_stack_2_current_density if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_2_current_density]) else pd.DataFrame()
            new_aec_stack_3_current_density_df = pd.concat([df for df in all_aec_stack_3_current_density if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_3_current_density]) else pd.DataFrame()
            new_aec_stack_4_current_density_df = pd.concat([df for df in all_aec_stack_4_current_density if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_stack_4_current_density]) else pd.DataFrame()
            new_aec_oxygen_temp_df = pd.concat([df for df in all_aec_oxygen_temp if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_oxygen_temp]) else pd.DataFrame()
            new_aec_hydrogen_temp_df = pd.concat([df for df in all_aec_hydrogen_temp if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_hydrogen_temp]) else pd.DataFrame()
            new_aec_oxygen_pressure_df = pd.concat([df for df in all_aec_oxygen_pressure if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_aec_oxygen_pressure]) else pd.DataFrame()
            new_active_state_df = pd.concat([df for df in all_active_state if not df.empty and not df.isna().all().all()], ignore_index=True) if any([not df.empty and not df.isna().all().all() for df in all_active_state]) else pd.DataFrame()
